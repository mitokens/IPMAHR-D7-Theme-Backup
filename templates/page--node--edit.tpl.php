<?php
	/* dynamically add css files by node id */
	drupal_add_css(drupal_get_path('theme',$GLOBALS['theme']).'/css/page--node--edit.tpl.css');
	drupal_add_css(drupal_get_path('theme',$GLOBALS['theme']).'/css/page--node-'.$node->nid.'--edit.tpl.css');
?>
